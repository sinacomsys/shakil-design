...
function InternalTabPane(_a) {
  ...
  var _b = (0, theme_1.useTheme)().tab,
    _c = _b === void 0 ? {} : _b,
    textColor = _c.textColor;
        ...
        children: [
            ...
            children:
              typeof renderTitle === "string"
                ? (0, jsx_runtime_1.jsx)(
                    "div",
                    __assign(
                      { className: classes["tab-pane-title"] },
                      {
                        children: (0, jsx_runtime_1.jsx)(
                          atoms_1.Text,
                          __assign(
                            { size: 14, theme: "Regular", color: textColor },
                ...
                ? (0, jsx_runtime_1.jsx)(
                    "div",
                    __assign(
                      { className: classes["rendered-title-wrap"] },
                      { children: renderTitle({ id: id, isActive: isActive }) },
                    ),
                  )
                : null,
          }),
          !!closeable &&
            (0, jsx_runtime_1.jsx)(
              "div",
              __assign(
                { className: classes["tab-pane-close"] },
                {
                  children: (0, jsx_runtime_1.jsx)(atoms_1.BaseIcon, {
                    color: "#575757",
