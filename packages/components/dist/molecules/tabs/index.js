...
var Tabs = function (_a) {
    ...
    return ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ className: (0, classnames_1.default)(classes["tabs"], className) }, { children: [(0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ className: classes["tabsContainer"] }, { children: [TabsTitle ? ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ style: {
                            backgroundColor: "white",
                            borderTopLeftRadius: 20,
                        } }, { children: typeof TabsTitle === "string" ? ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ className: classes["tabsTitle"] }, { children: (0, jsx_dev_runtime_1.jsxDEV)(text_1.Text, __assign({ theme: "Regular", size: "".concat((0, utils_1.pxToVh)(20), "vh"), color: textColor }, { children: TabsTitle }), void 0, false, { fileName: _jsxFileName, lineNumber: 90, columnNumber: 17 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 88, columnNumber: 47 }, _this)) : typeof TabsTitle === "object" ? (TabsTitle) : null }), void 0, false, { fileName: _jsxFileName, lineNumber: 81, columnNumber: 23 }, _this)) : null, (0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ ref: tabListRef, className: classes["tabsList"] }, { children: items === null || items === void 0 ? void 0 : items.map(function (_a) {
                            var id = _a.id, renderTitle = _a.renderTitle, closeable = _a.closeable;
                            var isActive = id === _activeTab;
                            return ((0, jsx_dev_runtime_1.jsxDEV)(internalTabPane_1.InternalTabPane, { renderTitle: renderTitle, isActive: isActive, onClick: handleOnChange, id: id, onClose: handleOnClose, closable: Boolean(closeable) }, id, false, { fileName: _jsxFileName, lineNumber: 107, columnNumber: 21 }, _this));
                        }) }), void 0, false, { fileName: _jsxFileName, lineNumber: 104, columnNumber: 9 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 80, columnNumber: 7 }, _this), (0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ className: classes["tabsContentContainer"] }, { children: noContent ? ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ style: { height: "100%" } }, { children: noContent }), void 0, false, { fileName: _jsxFileName, lineNumber: 123, columnNumber: 23 }, _this)) : (openedTabs.map(function (_id) {
