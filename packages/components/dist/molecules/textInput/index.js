...
var TextInput = React.forwardRef(function (_a, forwardedRef) {
    ...
    var passwordToggleVisibilityIcon = isPasswordVisible ? ((0, jsx_runtime_1.jsx)(atoms_1.BaseIcon, { wrapperClassName: classes["password-visible-icon"], onClick: togglePasswordVisibility, name: "Faults-_-Table-_-Acknowledge-selected", size: { height: 12, width: 19 } })) : ((0, jsx_runtime_1.jsx)(atoms_1.BaseIcon, { wrapperClassName: classes["password-visible-icon"], onClick: togglePasswordVisibility, name: "Faults-_-Table-_-Acknowledge-not-selected", size: { height: 12, width: 19 } }));
    var addOnAfterIcon = isLoading ? ((0, jsx_runtime_1.jsx)(atoms_1.Spinner, { size: "small" })) : type === "password" ? (passwordToggleVisibilityIcon) : _value && allowClear && !disabled ? (clearIcon) : AddonAfter ? (AddonAfter) : null;
    return multiline ? ((0, jsx_runtime_1.jsx)("textarea", __assign({ className: (0, classnames_1.default)(classes["text-area"], disabled && classes.disabled, (hasError || errorMessage) && classes["input-with-error"], themes[theme || "Regular"], className), ref: setRef, value: _value }, supportedProps))) : ((0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, classnames_1.default)(classes["inputWrapper"], wrapperClassName && wrapperClassName), style: wrapperStyle }, { children: [(0, jsx_runtime_1.jsx)("input", __assign({}, supportedProps, { type: type === "password" && !isPasswordVisible ? "password" : "text", value: _value, className: (0, classnames_1.default)(classes["textInput"], (hasError || errorMessage) && classes["input-with-error"], addOnAfterIcon && "".concat(classes["textInput"], "--input-with-addon-after"), addonBefore && "".concat(classes["textInput"], "--input-with-addon-before"), (disabled || isLoading) && classes.disabled, themes[theme || "Regular"], className), ref: setRef, disabled: disabled || isLoading, style: __assign({}, supportedProps.style) })), errorMessage ? ((0, jsx_runtime_1.jsx)(atoms_1.Text, __assign({ className: (0, classnames_1.default)(classes["error-message"], errorMessageClassName), color: (_b = Colors.textInput) === null || _b === void 0 ? void 0 : _b.errorMessage, size: 13 }, { children: errorMessage }))) : null, addonBefore ? ((0, jsx_runtime_1.jsx)("div", __assign({ className: (0, classnames_1.default)(classes["addonBefore"], addonBeforeClassName && addonBeforeClassName), style: addonBeforeStyle }, { children: addonBefore }))) : null, addOnAfterIcon ? ((0, jsx_runtime_1.jsx)("div", __assign({ className: (0, classnames_1.default)(classes["addonAfter"], addonAfterClassName && addonAfterClassName) }, { children: addOnAfterIcon }))) : null] })));
});
