...
var _jsxFileName =
  "D:/project/shakil-design-release/packages/components/src/molecules/radio/internalRadio/index.tsx";
...
var InternalRadio = react_1.default.forwardRef(function (_a, ref) {
  var children = _a.children,
    ...
    onFocus = _a.onFocus,
    onBlur = _a.onBlur,
    rest = __rest(_a, ["children", "value", "onFocus", "onBlur"]);
  var classes = (0, style_1.useStyles)();
  var _b = (0, theme_1.useTheme)(),
    _c = _b.radio,
    _d = _c === void 0 ? {} : _c,
    disableInnerCircleSelected = _d.disableInnerCircleSelected,
    disableInnerCricleUnselected = _d.disableInnerCricleUnselected,
    disableStroke = _d.disableStroke,
    enableInnerCircleSelected = _d.enableInnerCircleSelected,
    enableInnerCircleUnselected = _d.enableInnerCircleUnselected,
    enableStroke = _d.enableStroke,
    disableText = _b.disableText,
    primary = _b.primary;
  var _e = (0, react_1.useState)(false),
    isFocused = _e[0],
    setFocus = _e[1];
  var _f = (0, react_1.useContext)(context_1.RadioContext),
    onChange = _f.onChange,
    contextValue = _f.value,
    name = _f.name;
  ...
  var _value = value ? value : undefined;
  ...
  return (0, jsx_dev_runtime_1.jsxDEV)(
      ...
      { className: classes["label"] },
      {
        children: [
          (0, jsx_dev_runtime_1.jsxDEV)(
            ...
            void 0,
            true,
            { fileName: _jsxFileName, lineNumber: 73, columnNumber: 9 },
            _this,
          ),
            ...
            ? (0, jsx_dev_runtime_1.jsxDEV)(
                "span",
                {
                  children: (0, jsx_dev_runtime_1.jsxDEV)(
                    text_1.Text,
                    __assign(
                      { color: isDisabled ? disableText : primary },
                      { children: children },
                    ),
                    void 0,
                    false,
                ...
                void 0,
                false,
                { fileName: _jsxFileName, lineNumber: 102, columnNumber: 42 },
                _this,
              )
            : (0, jsx_dev_runtime_1.jsxDEV)(
                "span",
                ...
                void 0,
                false,
                { fileName: _jsxFileName, lineNumber: 106, columnNumber: 14 },
                _this,
              ),
        ],
      },
    ...
    void 0,
    true,
    { fileName: _jsxFileName, lineNumber: 71, columnNumber: 13 },
    _this,
  );
});
