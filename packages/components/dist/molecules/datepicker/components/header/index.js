...
var _jsxFileName =
  "D:/project/shakil-design-release/packages/components/src/molecules/datepicker/components/header/index.tsx";
...
var Header = function () {
  var _a = (0, react_1.useContext)(context_1.DatePickerContext),
    ...
    onAddMonth = _a.onAddMonth,
    onAddYear = _a.onAddYear,
    onSubtractMonth = _a.onSubtractMonth,
    onSubtractYear = _a.onSubtractYear,
    calendarMode = _a.calendarMode;
  var classes = (0, style_1.useStyle)();
  var date =
    currentDate &&
    new Date(
      Number((0, moment_jalaali_1.default)(currentDate).format("YYYY")),
      Number((0, moment_jalaali_1.default)(currentDate).format("MM")) - 1,
      Number((0, moment_jalaali_1.default)(currentDate).format("DD")),
    );
  var month =
    date &&
  ...
  return (0, jsx_dev_runtime_1.jsxDEV)(
      ...
      { className: classes["wrapper"] },
      {
        children: [
          (0, jsx_dev_runtime_1.jsxDEV)(
            ...
            void 0,
            false,
            { fileName: _jsxFileName, lineNumber: 40, columnNumber: 7 },
            _this,
          ),
          (0, jsx_dev_runtime_1.jsxDEV)(
            atoms_1.BaseIcon,
              ...
              { className: classes["month"] },
              {
                children: [
                  (0, jsx_dev_runtime_1.jsxDEV)(
                    atoms_1.Text,
                    __assign(
                      { size: 14, color: "white", theme: "Regular" },
                      {
                        children:
                          month !== null && month !== void 0 ? month : "",
                      },
                    ),
                    void 0,
                    false,
                  ...
                  (0, jsx_dev_runtime_1.jsxDEV)(
                    ...
                    void 0,
                    true,
                    { fileName: _jsxFileName, lineNumber: 64, columnNumber: 9 },
                    _this,
                  ),
                ],
              },
    ...
    void 0,
    true,
    { fileName: _jsxFileName, lineNumber: 38, columnNumber: 11 },
    _this,
  );
};
