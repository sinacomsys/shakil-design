...
var _jsxFileName =
  "D:/project/shakil-design-release/packages/components/src/molecules/datepicker/components/expandIcon/index.tsx";
      ...
      { className: classes["wrapper"] },
      {
        children: [
          (0, jsx_dev_runtime_1.jsxDEV)(
            atoms_1.BaseIcon,
            {
              wrapperClassName: "".concat(classes["wrapper"], "--more-choices"),
              color: "#eeeeee",
