...
var _jsxFileName =
  "D:/project/shakil-design-release/packages/components/src/molecules/datepicker/components/daysOfWeek/index.tsx";
...
var DaysOfWeekTitle = function () {
  ...
  var calendarMode = (0, react_1.useContext)(
  ...
  return (0, jsx_dev_runtime_1.jsxDEV)(
    ...
    __assign(
      {
        className: (0, classnames_1.default)(
          ...
          calendarMode === "gregorian" &&
            "".concat(classes["container"], "--gregorian"),
        ),
      },
      {
        children: daysOfWeek.map(function (item, index) {
          return (0,
    ...
    void 0,
    false,
    { fileName: _jsxFileName, lineNumber: 17, columnNumber: 11 },
    _this,
  );
};
