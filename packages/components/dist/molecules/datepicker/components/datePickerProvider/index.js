...
var DatePickerProvider = function (_a) {
    var handleExtendCalendar = _a.handleExtendCalendar, isCalendarExtended = _a.isCalendarExtended, value = _a.value, _b = _a.calendarMode, calendarMode = _b === void 0 ? "persian" : _b, onOkDate = _a.onOkDate, disableDateFrom = _a.disableDateFrom, onEditAgain = _a.onEditAgain, isDisable = _a.isDisable, children = _a.children;
    ...
    var _d = (0, react_1.useState)([]), monthMatrix = _d[0], setMonthMatrix = _d[1];
    ...
    (0, react_1.useEffect)(function () {
        if (!currentDate)
            return;
        setMonthMatrix((0, chuckDaysOfMonth_1.chunkDaysOfMonth)(currentDate, isPersian));
    ...
    return ((0, jsx_dev_runtime_1.jsxDEV)(context_1.DatePickerContext.Provider, __assign({ value: {
        ...
        } }, { children: children({ value: selectedDate, disable: !isConfirmed }) }), void 0, false, { fileName: _jsxFileName, lineNumber: 165, columnNumber: 11 }, _this));
};
var DatePickerProviderWrapper = function (props) {
    return ((0, jsx_dev_runtime_1.jsxDEV)(context_2.ManualImportDateContext.Provider, __assign({ mode: "onChange" }, { children: (0, jsx_dev_runtime_1.jsxDEV)(DatePickerProvider, __assign({}, props), void 0, false, { fileName: _jsxFileName, lineNumber: 209, columnNumber: 7 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 207, columnNumber: 11 }, _this));
};
