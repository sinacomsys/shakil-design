...
var _jsxFileName =
  "D:/project/shakil-design-release/packages/components/src/molecules/datepicker/components/rangePickerPanel/rangePickerPanel.tsx";
...
var RangePickerPanel = function (_a) {
  ...
  var _d = (0, react_1.useState)(false),
    isStartDateDisable = _d[0],
    setStartDateDisable = _d[1];
  var _e = (0, react_1.useState)(true),
    isEndDateDisable = _e[0],
    setEndDateDisable = _e[1];
  var _f = (0, react_1.useState)(false),
    isStartDateExtended = _f[0],
    setStartDateExtend = _f[1];
  var _g = (0, react_1.useState)(false),
    isEndDateExtended = _g[0],
    setEndDateExtend = _g[1];
  ...
  var handleSetEndDate = function (value) {
    ...
    if (
      value === null || value === void 0
        ? void 0
        : value.isBefore(startDate, "minute")
    ) {
      setEndDate(null);
    }
  };
  ...
  var handleExtendStartDate = function () {
    setStartDateExtend(function (prev) {
      return !prev;
    });
  };
  var handleExtendEndDate = function () {
    setEndDateExtend(function (prev) {
      return !prev;
    });
  };
  var isConfirmDisable =
    !isStartDateDisable || !isEndDateDisable || !startDate || !endDate;
  return (0, jsx_dev_runtime_1.jsxDEV)(
    wrapperTemplate_1.WrapperTemplate,
    __assign(
      { disable: isConfirmDisable, onFinalConfirm: handleFinalConfirm },
      {
        children: [
          (0, jsx_dev_runtime_1.jsxDEV)(
            datePickerProvider_1.DatePickerProvider,
            __assign(
              {
              ...
              },
              {
                children: function () {
                  return (0, jsx_dev_runtime_1.jsxDEV)(
                    datePickerPanel_1.DatePickerPanel,
                    {},
                    void 0,
                    false,
                    {
            ...
            void 0,
            false,
            { fileName: _jsxFileName, lineNumber: 86, columnNumber: 7 },
            _this,
          ),
          (0, jsx_dev_runtime_1.jsxDEV)(
            datePickerProvider_1.DatePickerProvider,
            ...
            void 0,
            false,
            { fileName: _jsxFileName, lineNumber: 98, columnNumber: 7 },
            _this,
          ),
        ],
      },
    ...
    void 0,
    true,
    { fileName: _jsxFileName, lineNumber: 81, columnNumber: 11 },
    _this,
  );
};
