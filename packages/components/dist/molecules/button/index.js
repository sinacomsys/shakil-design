...
var _jsxFileName =
  "D:/project/shakil-design-release/packages/components/src/molecules/button/index.tsx";
...
var Button = react_1.default.forwardRef(function (_a, ref) {
  var children = _a.children,
    _b = _a.mode,
    mode = _b === void 0 ? "main" : _b,
    _c = _a.htmlType,
    htmlType = _c === void 0 ? "button" : _c,
    form = _a.form,
  ...
  var _e = (0, theme_1.useTheme)().button,
    _f = _e === void 0 ? {} : _e,
    dangerColor = _f.danger,
    mainColor = _f.main,
    successColor = _f.success;
    ...
    if (ripples.length > 0) {
      return ripples.map(function (_a) {
        var id = _a.id,
          rest = __rest(_a, ["id"]);
        return (0,
        jsx_dev_runtime_1.jsxDEV)("span", { style: __assign({}, rest), className: classes["ripple"] }, id, false, { fileName: _jsxFileName, lineNumber: 87, columnNumber: 19 }, _this);
      });
    }
  };
  ...
  return (0, jsx_dev_runtime_1.jsxDEV)(
    ...
    __assign(
      ...
      rest,
      {
        ...
        className: (0, classnames_1.default)(
          ...
          size === "small" && "".concat(classes["button"], "--small"),
          size === "middle" && "".concat(classes["button"], "--middle"),
      ...
      },
      {
        children: [
          (0, jsx_dev_runtime_1.jsxDEV)(
            ...
            void 0,
            false,
            { fileName: _jsxFileName, lineNumber: 141, columnNumber: 9 },
            _this,
          ),
          isLoading
            ? (0, jsx_dev_runtime_1.jsxDEV)(
                ...
                __assign(
                  { className: classes["loadingContainer"] },
                  {
                    children: (0, jsx_dev_runtime_1.jsxDEV)(
                      atoms_1.Spinner,
                      { spinerColor: spinnerColor, size: "medium" },
                      void 0,
                      false,
                      {
                        fileName: _jsxFileName,
                ...
                void 0,
                false,
                { fileName: _jsxFileName, lineNumber: 155, columnNumber: 23 },
                _this,
              )
            : null,
          (isLoading || disabled) &&
            (0, jsx_dev_runtime_1.jsxDEV)(
              ...
              void 0,
              false,
              { fileName: _jsxFileName, lineNumber: 160, columnNumber: 36 },
              _this,
            ),
          renderRipple(),
        ],
    ...
    void 0,
    true,
    { fileName: _jsxFileName, lineNumber: 114, columnNumber: 13 },
    _this,
  );
});
