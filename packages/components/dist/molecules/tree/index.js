...
var Tree = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: (0, classnames_1.default)(classes["wrapper"], level > 1 && unit === "pixel"
            ...
            return ((0, jsx_runtime_1.jsx)(collapse_1.Collapse, __assign({ onClick: onSelectItem, data: child, title: child.title, level: level, onLoadData: onLoadData, id: child.id, activeItemId: activeItemId, defaultOpen: Boolean(isExist), index: index }, { children: ((_a = child === null || child === void 0 ? void 0 : child.children) === null || _a === void 0 ? void 0 : _a.length) ? ((0, jsx_runtime_1.jsx)(levelProvider_1.LevelContext.Provider, __assign({ value: level + 1 }, { children: (0, jsx_runtime_1.jsx)(Tree, { onSelectItem: onSelectItem, data: child.children, onLoadData: onLoadData, activeItemId: activeItemId, defaultSeletedItem: defaultSeletedItem }) }))) : null }), child.id));
        }) })));
};
var TreeWrapper = function (_a) {
    var _b = _a.unit, unit = _b === void 0 ? "viewport" : _b, props = __rest(_a, ["unit"]);
    return ((0, jsx_runtime_1.jsx)(treeProvider_1.TreeContext.Provider, __assign({ value: { unit: unit } }, { children: (0, jsx_runtime_1.jsx)(Tree, __assign({}, props)) })));
};
