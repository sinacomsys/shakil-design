...
var BaseIcon = react_1.default.forwardRef(function (_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ ref: ref, className: (0, classnames_1.default)(wrapperClassName), style: __assign({ display: "inline-flex" }, wrapperStyle) }, rest, { children: (0, jsx_runtime_1.jsx)(createIconSet_1.IconTemplate, { name: name, color: color, size: size, iconsJson: selection_json_1.default }) })));
});
