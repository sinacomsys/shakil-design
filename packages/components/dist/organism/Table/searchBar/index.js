...
var _jsxFileName =
  "D:/project/shakil-design-release/packages/components/src/organism/Table/searchBar/index.tsx";
var __1 = require("..");
...
var SearchBar = function (_a) {
  ...
  var _b = (0, theme_1.useTheme)().table,
    _c = _b === void 0 ? {} : _b,
    clearFilterIconColor = _c.clearFilterIcon;
  ...
  return (0, jsx_dev_runtime_1.jsxDEV)(
    ...
    __assign(
      {
        "data-testid":
          testid === null || testid === void 0 ? void 0 : testid.filterBar,
        className: (0, classnames_1.default)(
          classes["wrapper"],
          searchBarClassName && searchBarClassName,
        ),
        style: __assign({}, searchBarStyle),
      },
      {
        children: [
          (0, jsx_dev_runtime_1.jsxDEV)(
            "th",
            {
              children: (0, jsx_dev_runtime_1.jsxDEV)(
                ...
                __assign(
                  {
                    className: "".concat(classes["clear-filter"], "--wrapper"),
                  },
                  {
                    children: [
                      ...
                      (0, jsx_dev_runtime_1.jsxDEV)(
                        "div",
                        __assign(
                          { className: classes["clear-filter"] },
                          {
                            children: clearFilterIcon
                              ? clearFilterIcon
                              : (0, jsx_dev_runtime_1.jsxDEV)(
                                  atoms_1.BaseIcon,
                                  {
