...
var Table = function (_a) {
    var _b, _c, _d;
    var data = _a.data, onCheckedRows = _a.onCheckedRows, rowKey = _a.rowKey, headerStyle = _a.headerStyle, headerClassName = _a.headerClassName, searchBarClassName = _a.searchBarClassName, searchBarToggle = _a.searchBarToggle, searchBarStyle = _a.searchBarStyle, filterIcon = _a.filterIcon, clearFilterIcon = _a.clearFilterIcon, isLoading = _a.isLoading, onSelectRow = _a.onSelectRow, height = _a.height, coloums = _a.coloums, noContent = _a.noContent, overScan = _a.overScan, testid = _a.testid, onRow = _a.onRow;
    var _e = (0, theme_1.useTheme)().table, _f = _e === void 0 ? {} : _e, header = _f.header;
    var classes = (0, style_1.useStyles)();
    var _g = (0, react_1.useState)(undefined), order = _g[0], setOrder = _g[1];
    var _h = (0, react_1.useState)(false), isSearchVisible = _h[0], setShowSearchBar = _h[1];
    var _j = (0, react_1.useState)(undefined), orderBy = _j[0], setOrderBy = _j[1];
    var _k = (0, react_1.useState)(undefined), selectedRow = _k[0], setSelectedRow = _k[1];
    var _l = (0, react_1.useState)([]), checkedRows = _l[0], setCheckRows = _l[1];
    var unit = (0, react_1.useContext)(context_2.UnitContext).unit;
    var _m = (0, react_1.useState)(false), isAllRowsChecked = _m[0], setAllRowsChecked = _m[1];
    ...
    var paddingBottom = getVirtualItems().length > 0
        ? getTotalSize() -
            (((_d = getVirtualItems()[getVirtualItems().length - 1]) === null || _d === void 0 ? void 0 : _d.end) || 0)
        : 0;
    var isIndeterminate = checkedRows.length > 0 && checkedRows.length !== (data || []).length;
    var _noContent = noContent ? noContent : (0, jsx_dev_runtime_1.jsxDEV)(noContent_1.NoContent, { text: "No Data!" }, void 0, false, { fileName: _jsxFileName, lineNumber: 250, columnNumber: 45 }, _this);
            ...
            return ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ ref: measureRef, style: {
                    height: height,
                            ...
                            virtualizer: rowVirtualizer,
                                                    ...
                                                    } }, void 0, false, { fileName: _jsxFileName, lineNumber: 293, columnNumber: 21 }, _this), coloums.map(function (_a) {
                                                    var width = _a.width, dataIndex = _a.dataIndex;
                                                    var _width = isViewPortUnit && width ? (0, utils_1.pxToVwString)(width) : width;
                                                    return ((0, jsx_dev_runtime_1.jsxDEV)("col", { style: { width: _width ? _width : colWidth } }, dataIndex, false, { fileName: _jsxFileName, lineNumber: 301, columnNumber: 31 }, _this));
                                                }), isOverflowed ? ((0, jsx_dev_runtime_1.jsxDEV)("col", { style: { width: exports.SCROLL_BAR } }, void 0, false, { fileName: _jsxFileName, lineNumber: 308, columnNumber: 38 }, _this)) : null] }, void 0, true, { fileName: _jsxFileName, lineNumber: 292, columnNumber: 19 }, _this), (0, jsx_dev_runtime_1.jsxDEV)("thead", __assign({ className: headerClassName, style: __assign({ backgroundColor: header }, headerStyle) }, { children: [(0, jsx_dev_runtime_1.jsxDEV)(header_1.Header, { filterIcon: filterIcon, isSearchVisible: isSearchVisible, onToggleSearchBar: isSearchAvailable && onToggleSearchBar, columns: coloums, isIndeterminate: isIndeterminate }, void 0, false, { fileName: _jsxFileName, lineNumber: 319, columnNumber: 21 }, _this), isSearchAvailable ? ((0, jsx_dev_runtime_1.jsxDEV)(searchBar_1.SearchBar, { isIndeterminate: isIndeterminate, clearFilterIcon: clearFilterIcon, searchBarStyle: searchBarStyle, searchBarClassName: searchBarClassName, columns: coloums, data: data || [], isSearchVisible: isSearchVisible }, void 0, false, { fileName: _jsxFileName, lineNumber: 327, columnNumber: 43 }, _this)) : null] }), void 0, true, { fileName: _jsxFileName, lineNumber: 312, columnNumber: 19 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 291, columnNumber: 17 }, _this), (0, jsx_dev_runtime_1.jsxDEV)(atoms_1.ScrollView, __assign({ ref: tableContainerRef, className: classes["table-body"] }, { children: (0, jsx_dev_runtime_1.jsxDEV)(body_1.TableBody, { paddingTop: paddingTop, paddingBottom: paddingBottom, noContent: _noContent, searchIconWidth: _searchIconWidth, virtualRows: getVirtualItems(), checkedRows: checkedRows, colWidth: colWidth, coloums: coloums, dataList: list, handleCheckRow: handleCheckRow, data: data, rowKey: rowKey }, void 0, false, { fileName: _jsxFileName, lineNumber: 344, columnNumber: 19 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 340, columnNumber: 17 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 290, columnNumber: 15 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 273, columnNumber: 13 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 257, columnNumber: 17 }, _this));
        } }), void 0, false, { fileName: _jsxFileName, lineNumber: 252, columnNumber: 11 }, _this));
};
exports.Table = Table;
