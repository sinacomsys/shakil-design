...
var Table = function (_a) {
    ...
    var _b = (0, theme_1.useTheme)().table, _c = _b === void 0 ? {} : _b, header = _c.header;
    var classes = (0, style_1.useStyles)();
    var _d = (0, react_1.useState)(undefined), order = _d[0], setOrder = _d[1];
    var _e = (0, react_1.useState)(false), isSearchVisible = _e[0], setShowSearchBar = _e[1];
    var _f = (0, react_1.useState)(undefined), orderBy = _f[0], setOrderBy = _f[1];
    var _g = (0, react_1.useState)(undefined), selectedRow = _g[0], setSelectedRow = _g[1];
    var _h = (0, react_1.useState)([]), checkedRows = _h[0], setCheckRows = _h[1];
    var unit = (0, react_1.useContext)(context_2.UnitContext).unit;
    var _j = (0, react_1.useState)(false), isAllRowsChecked = _j[0], setAllRowsChecked = _j[1];
    ...
    var getVirtualItems = rowVirtualizer.getVirtualItems;
    var isIndeterminate = checkedRows.length > 0 && checkedRows.length !== (data || []).length;
    var _noContent = noContent ? noContent : (0, jsx_dev_runtime_1.jsxDEV)(noContent_1.NoContent, { text: "No Data!" }, void 0, false, { fileName: _jsxFileName, lineNumber: 240, columnNumber: 45 }, _this);
            ...
            return ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ ref: measureRef, style: {
                    height: height,
                            ...
                            virtualizer: rowVirtualizer,
                                                    ...
                                                    } }, void 0, false, { fileName: _jsxFileName, lineNumber: 283, columnNumber: 21 }, _this), coloums.map(function (_a) {
                                                    var width = _a.width, dataIndex = _a.dataIndex;
                                                    var _width = isViewPortUnit && width ? (0, utils_1.pxToVwString)(width) : width;
                                                    return ((0, jsx_dev_runtime_1.jsxDEV)("col", { style: { width: _width ? _width : colWidth } }, dataIndex, false, { fileName: _jsxFileName, lineNumber: 291, columnNumber: 31 }, _this));
                                                }), isOverflowed ? ((0, jsx_dev_runtime_1.jsxDEV)("col", { style: { width: exports.SCROLL_BAR } }, void 0, false, { fileName: _jsxFileName, lineNumber: 298, columnNumber: 38 }, _this)) : null] }, void 0, true, { fileName: _jsxFileName, lineNumber: 282, columnNumber: 19 }, _this), (0, jsx_dev_runtime_1.jsxDEV)("thead", __assign({ className: headerClassName, style: __assign({ backgroundColor: header }, headerStyle) }, { children: [(0, jsx_dev_runtime_1.jsxDEV)(header_1.Header, { filterIcon: filterIcon, isSearchVisible: isSearchVisible, onToggleSearchBar: isSearchAvailable && onToggleSearchBar, columns: coloums, isIndeterminate: isIndeterminate }, void 0, false, { fileName: _jsxFileName, lineNumber: 309, columnNumber: 21 }, _this), isSearchAvailable ? ((0, jsx_dev_runtime_1.jsxDEV)(searchBar_1.SearchBar, { isIndeterminate: isIndeterminate, clearFilterIcon: clearFilterIcon, searchBarStyle: searchBarStyle, searchBarClassName: searchBarClassName, columns: coloums, data: data || [], isSearchVisible: isSearchVisible }, void 0, false, { fileName: _jsxFileName, lineNumber: 317, columnNumber: 43 }, _this)) : null] }), void 0, true, { fileName: _jsxFileName, lineNumber: 302, columnNumber: 19 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 281, columnNumber: 17 }, _this), (0, jsx_dev_runtime_1.jsxDEV)(atoms_1.ScrollView, __assign({ ref: tableContainerRef, className: classes["table-body"] }, { children: (0, jsx_dev_runtime_1.jsxDEV)(body_1.TableBody, { noContent: _noContent, searchIconWidth: _searchIconWidth, virtualRows: getVirtualItems(), checkedRows: checkedRows, colWidth: colWidth, coloums: coloums, dataList: list, handleCheckRow: handleCheckRow, data: data, rowKey: rowKey }, void 0, false, { fileName: _jsxFileName, lineNumber: 334, columnNumber: 19 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 330, columnNumber: 17 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 280, columnNumber: 15 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 263, columnNumber: 13 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 247, columnNumber: 17 }, _this));
        } }), void 0, false, { fileName: _jsxFileName, lineNumber: 242, columnNumber: 11 }, _this));
};
exports.Table = Table;
