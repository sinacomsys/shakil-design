...
var Rows = function (_a) {
    var rowData = _a.rowData, columns = _a.columns, rowIndex = _a.index, virtualItem = _a.virtualItem;
    ...
    return ((0, jsx_dev_runtime_1.jsxDEV)(row_1.Row, __assign({ virtualItem: virtualItem, rowData: rowData, rowIndex: rowIndex, isSelected: Boolean(rowKey && _selectedRow && _selectedRow[rowKey] === rowData[rowKey]), isChecked: Boolean(isChecked) }, { children: [(0, jsx_dev_runtime_1.jsxDEV)("td", __assign({ style: { height: "inherit" } }, { children: [rowKey && selectedRow && _selectedRow[rowKey] === rowData[rowKey] ? ((0, jsx_dev_runtime_1.jsxDEV)("div", { className: classes["selected"] }, void 0, false, { fileName: _jsxFileName, lineNumber: 51, columnNumber: 79 }, _this)) : null, mode === "multiple" ? ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ onClick: function (e) {
                ...
                return ((0, jsx_dev_runtime_1.jsxDEV)(cell_1.Cell, __assign({ ellipsis: ellipsis, align: align }, { children: (0, jsx_dev_runtime_1.jsxDEV)(jsx_dev_runtime_1.Fragment, { children: render
                            ...
                            : cell }, void 0, false, { fileName: _jsxFileName, lineNumber: 73, columnNumber: 13 }, _this) }), index, false, { fileName: _jsxFileName, lineNumber: 71, columnNumber: 17 }, _this));
            })] }), void 0, true, { fileName: _jsxFileName, lineNumber: 40, columnNumber: 11 }, _this));
};
exports.Rows = Rows;
