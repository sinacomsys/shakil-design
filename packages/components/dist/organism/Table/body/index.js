...
var _jsxFileName = "D:/project/shakil-design/packages/components/src/organism/Table/body/index.tsx";
...
var TableBody = function (_a, ref) {
    ...
    return ((0, jsx_dev_runtime_1.jsxDEV)(jsx_dev_runtime_1.Fragment, { children: virtualRows.length > 0 ? ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ style: { height: "".concat((_b = virtualizer === null || virtualizer === void 0 ? void 0 : virtualizer.getTotalSize()) !== null && _b !== void 0 ? _b : 0, "px") } }, { children: (0, jsx_dev_runtime_1.jsxDEV)("table", __assign({ ref: ref, className: classes["wrapper"], role: "table" }, { children: [(0, jsx_dev_runtime_1.jsxDEV)("colgroup", { children: [(0, jsx_dev_runtime_1.jsxDEV)("col", { style: { width: searchIconWidth } }, void 0, false, { fileName: _jsxFileName, lineNumber: 73, columnNumber: 15 }, _this), coloums.map(function (_a) {
                                var width = _a.width, dataIndex = _a.dataIndex;
                                var _width = unit === "viewport" && width ? (0, src_1.pxToVwString)(width) : width;
                                return ((0, jsx_dev_runtime_1.jsxDEV)("col", { style: { width: _width ? _width : colWidth } }, dataIndex, false, { fileName: _jsxFileName, lineNumber: 77, columnNumber: 25 }, _this));
                            })] }, void 0, true, { fileName: _jsxFileName, lineNumber: 72, columnNumber: 13 }, _this), (0, jsx_dev_runtime_1.jsxDEV)("tbody", __assign({ "data-testid": testid === null || testid === void 0 ? void 0 : testid.body }, { children: [paddingTop > 0 && (0, jsx_dev_runtime_1.jsxDEV)(topFreeSpace_1.FreeSpace, { amount: paddingTop }, void 0, false, { fileName: _jsxFileName, lineNumber: 86, columnNumber: 33 }, _this), virtualRows.map(function (virtualRow, index) {
                                var row = dataList[virtualRow.index];
                                if (virtualRows.length === index + 1) {
                                    return ((0, jsx_dev_runtime_1.jsxDEV)(rowContainer_1.RowContainer, { lastItem: lastItemRef, rowData: row, index: index, columns: coloums, virtualItem: virtualRow }, rowKey ? row[rowKey] : index, false, { fileName: _jsxFileName, lineNumber: 90, columnNumber: 27 }, _this));
                                }
                                return ((0, jsx_dev_runtime_1.jsxDEV)(rowContainer_1.RowContainer, { rowData: row, index: index, columns: coloums, virtualItem: virtualRow }, rowKey ? row[rowKey] : index, false, { fileName: _jsxFileName, lineNumber: 101, columnNumber: 25 }, _this));
                            }), isLoadingMore ? ((0, jsx_dev_runtime_1.jsxDEV)(endOfList_1.EndOfList, { children: typeof isLoadingMore === "boolean" ? ((0, jsx_dev_runtime_1.jsxDEV)(atoms_1.Text, __assign({ size: 18 }, { children: "Loading..." }), void 0, false, { fileName: _jsxFileName, lineNumber: 113, columnNumber: 58 }, _this)) : (isLoadingMore) }, void 0, false, { fileName: _jsxFileName, lineNumber: 111, columnNumber: 33 }, _this)) : null, endOfList ? ((0, jsx_dev_runtime_1.jsxDEV)(endOfList_1.EndOfList, { children: typeof endOfList === "string" ? ((0, jsx_dev_runtime_1.jsxDEV)(atoms_1.Text, __assign({ size: 20 }, { children: endOfList }), void 0, false, { fileName: _jsxFileName, lineNumber: 122, columnNumber: 53 }, _this)) : (endOfList) }, void 0, false, { fileName: _jsxFileName, lineNumber: 120, columnNumber: 29 }, _this)) : null, paddingBottom > 0 && (0, jsx_dev_runtime_1.jsxDEV)(topFreeSpace_1.FreeSpace, { amount: paddingBottom }, void 0, false, { fileName: _jsxFileName, lineNumber: 130, columnNumber: 36 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 85, columnNumber: 13 }, _this)] }), void 0, true, { fileName: _jsxFileName, lineNumber: 71, columnNumber: 11 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 69, columnNumber: 34 }, _this)) : (noContent) }, void 0, false, { fileName: _jsxFileName, lineNumber: 67, columnNumber: 11 }, _this));
};
