...
var Select = function (_a) {
    var data = _a.data, propValue = _a.value, _b = _a.labelExtractor, labelExtractor = _b === void 0 ? function (item) { return item.label; } : _b, _c = _a.valueExtractor, valueExtractor = _c === void 0 ? function (item) { return item.value; } : _c, onChange = _a.onChange, onClear = _a.onClear, disabled = _a.disabled, allowClear = _a.allowClear, AddonAfter = _a.AddonAfter, addonAfterClassName = _a.addonAfterClassName, addonAfterStyle = _a.addonAfterStyle, addonBefore = _a.addonBefore, addonBeforeClassName = _a.addonBeforeClassName, addonBeforeStyle = _a.addonBeforeStyle, className = _a.className, onBlur = _a.onBlur, onFocus = _a.onFocus, placeholder = _a.placeholder, style = _a.style, wrapperClassName = _a.wrapperClassName, wrapperStyle = _a.wrapperStyle, popupClassName = _a.popupClassName, popupStyles = _a.popupStyles, multiple = _a.multiple, onSearch = _a.onSearch, _d = _a.hasSearch, hasSearch = _d === void 0 ? true : _d, onMouseEnter = _a.onMouseEnter, onMouseLeave = _a.onMouseLeave, testid = _a.testid, errorMessage = _a.errorMessage, errorMessageClassName = _a.errorMessageClassName, hasError = _a.hasError, clearIconColor = _a.clearIconColor, isLoading = _a.isLoading;
    var classes = (0, style_1.useStyles)();
    var _e = (0, react_1.useState)(null), internalValue = _e[0], setInternalValue = _e[1];
    var body = (0, react_1.useRef)(null);
    var _f = (0, react_1.useState)(0), width = _f[0], setWidth = _f[1];
    var _g = (0, react_1.useState)(false), isVisible = _g[0], setVisible = _g[1];
    ...
    var _k = (0, react_1.useState)(null), popperElement = _k[0], setPopperElement = _k[1];
    var _l = (0, react_popper_1.usePopper)(referenceElement, popperElement, {
        placement: "bottom",
        strategy: "fixed",
        modifiers: [{ name: "offset", options: { offset: [0, 2] } }],
    }), poperStyles = _l.styles, attributes = _l.attributes;
    ...
    if (multiple) {
        ...
        var value = data.find(function (item) { return valueExtractor(item) === internalValue; });
        displayValue = value ? labelExtractor(value) : "";
    }
    return ((0, jsx_dev_runtime_1.jsxDEV)(jsx_dev_runtime_1.Fragment, { children: [(0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ ref: handleRefOfRefrenceElement }, { children: (0, jsx_dev_runtime_1.jsxDEV)(textInput_1.TextInput, __assign({}, {
                    ...
                    isLoading: isLoading,
                }, { onClear: handleOnClear, onClick: handleOnClick, value: displayValue, style: __assign({}, style), className: (0, classnames_2.default)(classes["text-input"], isLoading && "".concat(classes["text-input"], "--loading")), placeholder: placeholder, allowClear: allowClear, AddonAfter: (0, jsx_dev_runtime_1.jsxDEV)(fleshIcon_1.FleshIcon, { isVisible: isVisible }, void 0, false, { fileName: _jsxFileName, lineNumber: 180, columnNumber: 23 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 146, columnNumber: 9 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 145, columnNumber: 7 }, _this), body.current && isVisible
                ? react_dom_1.default.createPortal((0, jsx_dev_runtime_1.jsxDEV)(jsx_dev_runtime_1.Fragment, { children: (0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ ref: setPopperElement, style: poperStyles.popper }, attributes.popper, { children: (0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ "data-testid": testid === null || testid === void 0 ? void 0 : testid.overlay, style: __assign({ width: width }, popupStyles), className: (0, classnames_1.default)(popupClassName, classes["overlay"]) }, { children: [hasSearch ? ((0, jsx_dev_runtime_1.jsxDEV)("div", __assign({ className: classes["inputWrapper"] }, { children: (0, jsx_dev_runtime_1.jsxDEV)(textInput_1.TextInput, { value: searchValue, placeholder: "Search", AddonAfter: (0, jsx_dev_runtime_1.jsxDEV)(atoms_1.BaseIcon, { color: "#d1d1d1", name: "Search-Box_Search-Icon", size: { height: 15, width: 15 } }, void 0, false, { fileName: _jsxFileName, lineNumber: 202, columnNumber: 37 }, _this), onChangeText: function (value) {
                                            onSearch === null || onSearch === void 0 ? void 0 : onSearch(value);
                                            setSearchValue(value);
                                        } }, void 0, false, { fileName: _jsxFileName, lineNumber: 199, columnNumber: 23 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 197, columnNumber: 33 }, _this)) : null, multiple ? ((0, jsx_dev_runtime_1.jsxDEV)(multiSelect_1.MultiSelectList, { data: data, labelExtractor: labelExtractor, valueExtractor: valueExtractor, internalValue: internalValue, onClick: handleOnChange }, void 0, false, { fileName: _jsxFileName, lineNumber: 217, columnNumber: 32 }, _this)) : ((0, jsx_dev_runtime_1.jsxDEV)(singleSelect_1.SingleSelectList, { data: data, labelExtractor: labelExtractor, valueExtractor: valueExtractor, internalValue: internalValue, onClick: handleOnChange }, void 0, false, { fileName: _jsxFileName, lineNumber: 225, columnNumber: 24 }, _this))] }), void 0, true, { fileName: _jsxFileName, lineNumber: 192, columnNumber: 17 }, _this) }), void 0, false, { fileName: _jsxFileName, lineNumber: 187, columnNumber: 15 }, _this) }, void 0, false, { fileName: _jsxFileName, lineNumber: 185, columnNumber: 33 }, _this), body.current)
                : null] }, void 0, true, { fileName: _jsxFileName, lineNumber: 143, columnNumber: 11 }, _this));
};
