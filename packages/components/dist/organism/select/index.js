...
var Select = function (_a) {
    ...
    var _f = (0, react_1.useState)(null), internalValue = _f[0], setInternalValue = _f[1];
    var body = (0, react_1.useRef)(null);
    var _g = (0, react_1.useState)(0), width = _g[0], setWidth = _g[1];
    var _h = (0, react_1.useState)(false), isVisible = _h[0], setVisible = _h[1];
    var _j = (0, react_1.useState)(""), searchValue = _j[0], setSearchValue = _j[1];
    var _k = (0, react_1.useState)(null), referenceElement = _k[0], setReferenceElement = _k[1];
