...
var _jsxFileName =
  "D:/project/shakil-design-release/packages/components/src/organism/select/components/list/singleSelect/index.tsx";
  ...
  var selectedItem = data.find(function (item) {
    return (
      (valueExtractor === null || valueExtractor === void 0
        ? void 0
        : valueExtractor(item)) === internalValue
    );
  });
        ...
        children: [
          internalValue
            ? (0, jsx_dev_runtime_1.jsxDEV)(
                ...
                void 0,
                true,
                { fileName: _jsxFileName, lineNumber: 25, columnNumber: 25 },
                _this,
              )
            : null,
          internalValue
            ? (0, jsx_dev_runtime_1.jsxDEV)(
                ...
                void 0,
                false,
                { fileName: _jsxFileName, lineNumber: 33, columnNumber: 25 },
                _this,
              )
            : null,
          data
            ...
            .map(function (item) {
              ...
              return (0, jsx_dev_runtime_1.jsxDEV)(
                ...
                valueExtractor === null || valueExtractor === void 0
                  ...
                  : valueExtractor(item),
                false,
                { fileName: _jsxFileName, lineNumber: 40, columnNumber: 19 },
                _this,
              );
            }),
        ],
