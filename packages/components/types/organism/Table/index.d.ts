...
export interface TableCommonType<T> extends Pick<TableContextProps<T>, "testid" | "onRow" | "expandedRows"> {
    data?: T[];
    rowKey?: keyof T;
...
export interface TablePropsWithMultipleSelectRows<T> extends TableCommonType<T> {
    selectedRows?: T[];
...
declare function Table<T extends Record<string, any>>(props: TablePropsWithSingleSelectRow<T>): JSX.Element;
declare function Table<T extends Record<string, any>>(props: TablePropsWithMultipleSelectRows<T>): JSX.Element;
